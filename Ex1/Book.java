...
class Book {
     ...
     * separated by commas, in closed in square brackets. For example, if the book is
     * titled "Monkey Feet", was written by Ernie Douglas, published in 1987 and has a comic value
     * of 7, dramatic value of 3 and an educational value of 1, this method will return the string:
    ...
    /**
     * @return the literary value of this book, which is defined as the sum of its comic value, its
     * dramatic value and its educational value.
     */
    ...
    /**
     * Sets the given id as the id of the current borrower of this book, -1 if no patron is
     * currently borrowing it.
     * @param borrowerId Id of the current borrower of this book
     */
     ...
     */
    void returnBook(){
        setBorrowerId(-1); // this book has no borrower, set currentBorrowerId to -1
    }
}