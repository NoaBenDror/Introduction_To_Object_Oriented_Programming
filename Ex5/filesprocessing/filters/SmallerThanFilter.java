...
/** This class represents a filter that checks if file size is strictly less than the given
...
public class SmallerThanFilter extends Filter {
    ...
    public SmallerThanFilter(String[] conditionArray) throws Type1Exception {
