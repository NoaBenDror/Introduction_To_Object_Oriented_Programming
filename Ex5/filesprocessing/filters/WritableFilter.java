...
/** This class represents a filter that checks if files have or don't have writing permission.
 *  extends Filter  */
...
public class WritableFilter extends Filter {
    ...
    public WritableFilter(String[] conditionArray) throws Type1Exception {
